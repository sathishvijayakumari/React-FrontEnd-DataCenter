...
const Background = { backgroundColor: "#3381af", color: 'white' };
export function linkClicked(id) {
  let element = document.getElementsByClassName("sidebarmenu");
  element[0].style.backgroundColor = "";
  element[0].firstChild.style.color = "#000";
  element[1].style.backgroundColor = "";
  element[1].firstChild.style.color = "#000";
  element[2].style.backgroundColor = "";
  element[2].firstChild.style.color = "#000";
  element[3].style.backgroundColor = "";
  element[3].firstChild.style.color = "#000";
  element[4].style.backgroundColor = "";
  element[4].firstChild.style.color = "#000";
  element[5].style.backgroundColor = "";
  element[5].firstChild.style.color = "#000";
  element[id].style.backgroundColor = "#3381af";
  element[id].firstChild.style.color = "#FFF";
}
